...
const SEARCH_FILES=[
  'top3-search-pack-01.js','top3-search-pack-02.js','top3-search-pack-03.js','top3-search-pack-04.js',
  'top3-search-mini-001.js','top3-search-mini-002.js','top3-search-mini-003.js','top3-search-mini-004.js',
  'top3-search-mini-005.js','top3-search-mini-006.js','top3-search-mini-007.js','top3-search-mini-008.js',
  'top3-search-mini-009.js','top3-search-mini-010.js','top3-search-mini-011.js','top3-search-mini-012.js',
  'top3-search-tail-001.js','top3-search-tail-002.js','top3-search-tail-003.js','top3-search-tail-004.js',
  'top3-search-rest-001.js',
  'top3-search-bulk-001.js','top3-search-bulk-002.js','top3-search-bulk-003.js','top3-search-bulk-004.js',
  'top3-search-bulk-005.js','top3-search-bulk-006.js','top3-search-bulk-007.js','top3-search-bulk-008.js',
  'top3-search-bulk-009.js','top3-search-bulk-010.js','top3-search-bulk-011.js','top3-search-bulk-012.js','top3-search-bulk-013.js',
  'top3-search-pack-final.js'
];
...
async function loadEarlyArchive(){
  ...
  for(const name of SEARCH_FILES){
    const code=await fetchText(name);
    new Function('window','atob','Uint8Array','Date','Object',code)(sandbox,atob,Uint8Array,Date,Object);
  }
...
console.log(`FULL ARCHIVE OK: №${meta.fromDraw}…№${meta.toDraw}; total=${meta.total}; early=${early.length}; dated=${dated.combos.length}; last=${combos.at(-1)}`);
