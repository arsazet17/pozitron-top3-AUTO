...
d['note']='Тройни: M6 REPEAT-FAMILY-150 V2 + таблица лидеров M6-прогноза за последние 30 тиражей'
p.write_text(json.dumps(d,ensure_ascii=False,indent=2)+'\n',encoding='utf-8')

p=Path('sw.js')
s=p.read_text(encoding='utf-8')
s=re.sub(r'const CACHE="[^"]+";','const CACHE="top3-auto-v1310-m6-leaders30";',s,count=1)
p.write_text(s,encoding='utf-8')
