...
export function renderTriples(ctx){
 ...
 ${card("ПРАВИЛО",`<p><b>Раздел «Тройни» считается отдельно от CHAT MASTER.</b> M1 / M2 / M3, M6 V3 STRICT, серийный лидер, МАЯЧОК и таблица лидеров от тройни не получают MASTER score. M6 V3 — отдельный one-shot и не входит в CORE/M4; таблица повторных family за 150 тиражей остаётся отдельной аналитикой.</p>`)}`;
}
