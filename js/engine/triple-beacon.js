export const TRIPLE_BEACON_RULE_CODE="TOP3-BEACON-NO-REUSE-V2-18SEP2026";
export const TRIPLE_BEACON_WINDOW=50;
export const TRIPLE_BEACON_MAX_DISTANCE=20;

// В V1 ни один из 200 шаблонов type×distance не прошёл поправку BH.
// До отдельной честной проверки NO-REUSE V2 прогноз не включается постфактум.
// Новые подтверждённые шаблоны добавляются сюда только после frozen TRAIN→TEST проверки.
